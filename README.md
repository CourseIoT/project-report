...
|E7-TS134|Obtener y procesar datos de sensores mediante la Edge API|**Como** desarrollador **quiero** actaulizar el plan de suscripcion atraves de la API **para** quiero integrar el uso de la Edge API para obtener y procesar datos de sensores en el borde. | <p>**Escenario 1: Procesamiento y envío de datos desde la Edge API**</p><p>**Dado que** el endpoint "/api/v1/edge/sensors/data" está disponible.</p><p>**Cuando** el sistema envía una solicitud POST con los datos: sensorId, timestamp y rawData.</p><p>**Entonces** la aplicación procesa los datos localmente, genera métricas relevantes (por ejemplo, humidity, temperature, status) y devuelve una respuesta con estado 200, incluyendo el recurso: sensorId, processedData, alertLevel y timestamp.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |7|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
