...
| 23 | E4-US104 | Análisis financiero de la tienda | Como distribuidor quiero un análisis financiero para visualizar la utilidad de mi tienda. | 8 |
...
| 27 | E8-TS101 | Ver información financiera | Como administrador quiero ver la información financiera para ver el estado financiero en la aplicacioń | 2 |
| 28 | E8-TS102 | Registrar usuario vía APIRESTful | Como desarrollador quiero registrar al usuario a través de la API para persistir su información en la base de datos | 5 |
| 29 | E8-TS103 | Iniciar sesión de usuario | Como desarrollador quiero logear al usuario a través de la API para brindarle acceso a la aplicación | 3 |
| 30 | E8-TS104 | Obtener información del usuario | Como desarrollador quiero obtener información del usuario a través de la API para mostrar los datos en la aplicación | 3 |
| 31 | E8-TS105 | Crear campo | Como desarrollador quiero crear un campo a través de la API para registrarlo en la base de datos | 5 |
| 32 | E8-TS106 | Obtener campos | Como desarrollador quiero obtener la información de los campos a través de la API para mostrar los datos en la aplicación | 3 |
| 33 | E8-TS107 | Eliminar campo | Como desarrollador quiero eliminar la información del campo a través de la API para eliminar los datos en la aplicación | 2 |
| 34 | E8-TS108 | Editar campo | Como desarrollador quiero editar la información del campo a través de la API para modificar datos en la aplicación | 3 |
| 35 | E8-TS109 | Crear proceso agrícola | Como desarrollador quiero crear el proceso agrícola a través de la API para registrarlo en la base de datos | 5 |
| 36 | E8-TS110 | Crear actividad en proceso agrícola | Como desarrollador quiero crear actividades agrícolas a través de la API para registrarlas en la base de datos | 8 |
| 37 | E8-TS111 | Crear recurso en actividad | Como desarrollador quiero crear recursos en una actividad a través de la API para registrarlos en la base de datos | 5 |
| 38 | E8-TS112 | Obtener procesos por campo | Como desarrollador quiero obtener la información del proceso agrícola por campo a través de la API | 3 |
| 39 | E8-TS113 | Obtener proceso por ID | Como desarrollador quiero obtener la información de un proceso agrícola por identificador a través de la API | 2 |
| 40 | E8-TS114 | Obtener actividades por proceso | Como desarrollador quiero obtener la información de la actividad agrícola a través de la API | 3 |
| 41 | E8-TS115 | Obtener última actividad | Como desarrollador quiero obtener la información de la última actividad agrícola a través de la API | 2 |
| 42 | E8-TS116 | Terminar plantación | Como desarrollador quiero terminar la plantación a través de la API para registrarlo en la base de datos | 5 |
| 43 | E8-TS117 | Editar actividad agrícola | Como desarrollador quiero editar la información de una actividad a través de la API para actualizar datos en la aplicación | 3 |
| 44 | E8-TS118 | Agregar trabajador | Como desarrollador quiero agregar un trabajador a través de la API para registrarlo en la base de datos | 3 |
| 45 | E8-TS119 | Obtener trabajadores | Como desarrollador quiero obtener información de los trabajadores a través de la API | 2 |
| 46 | E8-TS120 | Eliminar trabajador | Como desarrollador quiero eliminar trabajadores a través de la API para limpiar datos en la aplicación | 2 |
| 47 | E8-TS121 | Agregar payment | Como desarrollador quiero agregar un payment a través de la API para registrarlo en la base de datos | 5 |
| 48 | E8-TS122 | Obtener payments | Como desarrollador quiero obtener información de los payments a través de la API | 3 |
| 49 | E8-TS123 | Crear financiamiento | Como desarrollador quiero crear datos de financiamiento a través de la API para registrarlos en la base de datos | 5 |
| 50 | E8-TS124 | Obtener financiamientos | Como desarrollador quiero obtener datos de financiamiento a través de la API para mostrarlos en la aplicación | 3 |
| 51 | E8-TS125 | Crear producto | Como desarrollador quiero crear productos a través de la API para registrarlos en la base de datos | 5 |
| 52 | E8-TS126 | Obtener productos | Como desarrollador quiero obtener productos a través de la API para mostrarlos en la aplicación | 3 |
| 53 | E8-TS127 | Obtener producto por nombre | Como desarrollador quiero obtener productos por nombre a través de la API para mostrarlos en la aplicación | 2 |
| 54 | E8-TS128 | Editar producto | Como desarrollador quiero editar la información de un producto a través de la API | 3 |
| 55 | E8-TS129 | Editar cantidad de producto | Como desarrollador quiero editar la cantidad de un producto a través de la API | 2 |
| 56 | E8-TS130 | Actualizar producto para propietario | Como desarrollador quiero actualizar la información de un producto para su propietario a través de la API | 3 |
| 57 | E8-TS131 | Crear suscripción | Como desarrollador quiero crear suscripciones a través de la API para registrarlas en la base de datos | 5 |
| 58 | E8-TS132 | Obtener suscripciones | Como desarrollador quiero obtener información de suscripciones a través de la API | 3 |
| 59 | E8-TS133 | Renovar suscripción | Como desarrollador quiero renovar suscripciones a través de la API para mantenerlas activas | 2 |
| 60 | E8-TS134 | Actualizar plan de suscripción | Como desarrollador quiero actualizar el plan de una suscripción a través de la API | 3 |                                                                                                                                                                                                                                                                                                                                                                                                              
