...
| Integrante                          | Actvidades Asignadas                                                                                                                                                |
|-------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Barrutia Vaez, Ricardo Andree       | - Actualización de documento <br> - Web Application <br> - Back-end |
| Espinoza Inoñan, Fabiola Ximena     | - Entorno IoT <br> - Capa Edge <br> - Actualización de documento |
| Mayta López, Harold                 | - Mobile app <br> - PPT <br> - Actualización de documento |
| Rodriguez Santos, David Bryan       | - Capa Edge <br> - Actualización de documento <br> - PPT |
| Barrionuevo Reto,  Jean Franco Joel | - Mobile app <br> - PPT <br> - Actualización de documento |
...
|------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|  
| Trabaja en equipo para proporcionar liderazgo en forma conjunta                                | **Rodriguez Santos, David Bryan** :<br> TB1: <br>Apoyé en la planificación de las actividades y en definir prioridades, lo que ayudó a que el equipo trabajara de manera más organizada. <br>TP1: <br> Agregué epicas en las historias de usuario acerca de las caracteristicas de nuestro proyecto relacionadas a los dispositivos IoT, Edge API, entre otras caracteristicas extras. <br> TB2: Realicé las evaluaciones segun heuristicas mostrando los problemas de usabilidad, inclusividad y información arquitectura de la aplicación web, aplicación movil y landing page. <br> TF: <br> Aporté en la creación de la capa Edge del producto, construyendo el backend y la base de datos. <br> **Mayta Lopez, Harold Jaime**:<br> TB1: <br>Contribuimos proponiendo alternativas técnicas y participando en las discusiones del grupo, ayudando a tomar decisiones de manera conjunta.   <br>TP1: <br> Presenté los prototipos de UX/UI y flujos de interacción con lenguaje claro y enfocado en la usabilidad, adaptando la explicación a públicos técnicos y no técnicos. <br> TB2: <br> Participé activamente en la planificación del Sprint 2, proporcionando liderazgo conjunto para definir prioridades y estimar tareas. Fomenté la toma de decisiones compartida durante el desarrollo de la app móvil para asegurar que el equipo avanzara de manera unificada. <br> TF: <br> Proporcioné liderazgo conjunto al organizar la planificación y documentación del Sprint 3, asegurando la alineación del equipo. Además, trabajé activamente apoyando a mis compañeros en la actualización técnica de la app para integrar los datos de los sensores. <br> **Espinoza Inoñan, Fabiola Ximena**:<br> TB1: <br>Colaboré en la toma de decisiones del grupo y en la coordinación de actividades, aportando ideas que ayudaron a mantener el trabajo ordenado. <br> TP1: <br> Me encargue de las correcciones de la entrega anterior y actualicé los capitulos correspondients. Acordé con el equipo los cambios de texto e imágenes y ajusté los apartados para que coincidan con las historias de usuario y el diseño de la web.<br> TB2: <br> Me encargue de las entrevistas de validación para nuestra solución. Y también de la creación o simulación de nuestro proyecto en wokwi y también la conexión y visualización de datos en beereceptor. <br> TF: Aporté en la implementación del armado del prototipo en Wokwi y, además, desarrollé el módulo completo utilizando los sensores necesarios para construir el dispositivo físico IoT, incluyendo su sistema de riego y el código para el ESP32 que garantiza su correcto funcionamiento. De esta manera, cumplí con el objetivo planteado para este último sprint.<br> contenido <br> **Barrutia Vaez, Ricardo Andree**: <br> TB1: <br>Participé en la organización del trabajo del equipo, proponiendo cómo repartir las tareas y apoyando en la coordinación para que todos avanzáramos en la misma dirección.<br> TP1: <br> Realice el UI/UIX de la landing page y la web app adiccionalmente  avancé Cap. 5 . Integré los comentarios del grupo en la interfaz y adapté secciones para que coincidan con lo priorizado en el backlog. <br> TB2: <br> A partir de las evaluaciones según heurísticas, ajusté el diseño de la landing page y de la web app para corregir problemas de usabilidad, legibilidad y consistencia visual. Incorporé las observaciones del equipo en la arquitectura de información y en los componentes de la interfaz, asegurando que las pantallas fueran más claras e inclusivas para distintos tipos de usuarios. <br> TF: <br> Aporté en la implementación de la lógica de control de la mini bomba y el montaje físico del actuador, siendo piezas clave para lograr el objetivo del Sprint 3 de Integración End-to-End IoT. Este trabajo complementó directamente la capa Edge y el backend del producto, lo que era un componente importante de la arquitectura final. <br> **Barrionuevo Reto, Jean Franco Joel**: <br> TB1: <br>Contribuimos proponiendo alternativas técnicas y participando en las discusiones del grupo, ayudando a tomar decisiones de manera conjunta.<br>  TP1: <br> Presenté el Plan de SCM (estrategia de ramas, versionado, control de cambios, trazabilidad CI/CD) con lenguaje claro y objetivo, respondiendo consultas de equipos técnicos y directivos. <br> TB2: <br> Ejercí liderazgo conjunto durante el desarrollo de la app móvil, tomando iniciativa para resolver problemas técnicos que afectaban al equipo. Apoyé a mis compañeros y participé activamente en las decisiones de implementación para asegurar el éxito colectivo.<br> TF: <br> Asumi la responsabilidad técnica de actualizar la app móvil. Coordiné con el equipo para asegurar que la integración visual de los datos de los sensores fuera coherente con la solución implementada. <br> | Como equipo demostramos la capacidad de organizarnos y asumir el liderazgo de manera compartida, distribuyendo las tareas según las fortalezas de cada integrante y apoyándonos mutuamente en el proceso. La coordinación y la comunicación constante nos permitieron mantener un rumbo claro y tomar decisiones conjuntas en cada etapa del proyecto.                                                                        |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | **Rodriguez Santos, David Bryan**:<br> TB1: <br>Organicé mis entregables respetando los plazos y coordinando con mis compañeros, ayudando a que el proyecto se complete en orden y a tiempo.  <br> TP1: <br> Agregué épicas en las historias de usuario que son importantes para nuestro proyecto, ayudando a priorizar esas funcionalidades y organizando mejor el proyecto. <br> TB2: Realicé las evaluaciones segun heuristicas siendo importante para ver los problemas de usabilidad, inclusividad y información de la arquitectura de la aplicación web, aplicaicón movil y aplicación web.  <br> TF: Aporté en la creación de la capa Edge del producto, ayudando a realizar un componente importante de la arquitectura del producto. <br> contenido <br> **Mayta Lopez, Harold Jaime**: <br> TB1: <br>Colaboré con mis compañeros para que las tareas técnicas se completaran de acuerdo con los objetivos planteados. Me mantuve en comunicación constante con el equipo para resolver dudas y asegurar que todos estuviéramos alineados en la planificación.  <br>  TP1: <br> Documenté los diseños de interfaz y wireframes, describiendo criterios de accesibilidad, navegación y consistencia visual con objetividad y precisión para distintos niveles jerárquicos. <br> TB2: <br> Contribuí a crear un entorno colaborativo en el Sprint 2, facilitando la definición de metas claras. Colaboré en la planificación de tareas para el desarrollo de la app y trabajé activamente con el equipo para cumplir los objetivos establecidos. <br> TF: <br> Fomenté un entorno colaborativo gestionando la documentación y planificando las tareas del Sprint 3. Establecí metas claras para la siguiente etapa y cumplí con el objetivo de apoyar en la implementación de la visualización de sensores en el móvil. <br> **Espinoza Inoñan, Fabiola Ximena**:, <br> TB1: <br>Trabajé de forma colaborativa compartiendo mis avances y escuchando a mis compañeros, lo que permitió integrar mejor cada parte del proyecto.  <br> TP1: <br> Documenté las guías de estilo (colores, tipografías y componentes), creé tareas claras en el tablero y subí cambios en partes pequeñas para facilitar la revisión. Entregué la landing y los ajustes de la web app dentro del plazo acordado. <br> TB2: <br> Trabaje de forma colaborativa con mis compañeros y también nos reunimos para explicarle los avance que tuve con la creación del wokwi y màs.  <br> TF: <br> Trabajé de forma colaborativa con mis compañeros para la finalización exitosa de este último sprint. Nos reunimos para realizar las pruebas necesarias del funcionamiento del dispositivo IoT con la capa Edge, cumpliendo así con los objetivos planteados. <br> **Barrutia Vaez, Ricardo Andree**: <br> TB1: <br>Cumplí con mis tareas de manera coordinada con el equipo y me aseguré de que mi trabajo encajara con el de los demás, contribuyendo a cumplir con las metas del proyecto.<br> TP1: <br> Diseñe las guías de estilo (colores, tipografías y componentes), creé tareas claras en el tablero y subí cambios en partes pequeñas para facilitar la revisión. Entregué la landing y los ajustes de la web app dentro del plazo acordado. <br> TB2: <br> Utilicé los resultados de las evaluaciones heurísticas para proponer mejoras en el diseño y organicé las tareas de ajuste en el tablero, de modo que el equipo tuviera claro qué cambiar y en qué orden. Coordine con mis compañeros los cambios visuales y de estructura en la landing page y la web app, promoviendo un entorno colaborativo donde todos pudieran opinar y validar las soluciones antes de integrarlas.<br> TF: <br> Me aseguré de que la implementación del hardware de riego se alineara con la capa Edge para garantizar el cumplimiento del objetivo principal del Sprint 3. Además, mi trabajo de mejora continua de la usabilidad y consistencia visual de la web app y landing page a lo largo de los sprints (TB2) fue crucial para que el producto final fuera accesible. <br> **Barrionuevo Reto, Jean Franco Joel**:  <br>TB1: <br>Nos aseguramos de que las decisiones técnicas fueran entendidas por el grupo y alineadas con los objetivos, fomentando un trabajo inclusivo y colaborativo.<br> TP1: <br> Redacté documentación de SCM (SCMP, políticas de branching/tagging, baselines, releases y auditorías de configuración) con estructura, precisión y objetividad para audiencias de distintas especialidades. <br> TB2: <br> Fomenté un entorno colaborativo al comunicar mi progreso en la app y participar en revisiones de código. Colaboré en establecer metas técnicas realistas, planifiqué mis tareas de desarrollo y cumplí los objetivos asignados, entregando las funcionalidades a tiempo. <br> TF: <br> Establecí la meta de visualizar los datos de los sensores en la app y planifiqué las tareas de actualización necesarias. Mantuve un entorno colaborativo y cumplí el objetivo de dejar la funcionalidad operativa. <br>| Logramos crear un entorno inclusivo y colaborativo donde todas las opiniones fueron tomadas en cuenta, lo que favoreció la integración de diferentes perspectivas y el cumplimiento de los objetivos planteados. Gracias a esta dinámica, pudimos planificar adecuadamente nuestras actividades, cumplir con los plazos establecidos y garantizar que el resultado final reflejara el esfuerzo y compromiso de todo el grupo. |
...
|E6-US101|Ver información financiera|**Como** administrador **quiero** ver la información financiera **para** ver el estado financiero en la aplicacioń| <p>**Escenario 1: Visualización de información financiera**</p><p>**Dado que** el usuario inicia sesión en la aplicación</p><p>**Cuando** entra la sección monetaria</p><p>**Entonces** muestra la información monetaria de la aplicación</p><p>**Escenario 2: Filtración de informacion por fecha**</p><p>**Dado que** el usuario inicia sesión en la aplicación</p><p>**Cuando** entra la sección monetaria y hace filtraciones por fecha</p><p>**Entonces** se muestra la información monetaria de la aplicación por fecha.</p>                                                                                                                                                             |6| 
...
|E7-TS101|Lectura de humedad del suelo|**Como** productor agricola **quiero** ver los valores actuales de humedad del suelo de una parcela **para** monitorear el estado de los cultivos| <p>**Escenario 1: Visualización de los datos**</p><p>**Dado que** el productor agricula inicia sesión en la aplicación</p><p>**Cuando** entra a la sección de parcelas, selecciona una parcela y va a la seccion de humedad </p><p>**Entonces** se muestran los valores de la humedad de la parcela en tiempo real.</p><p>**Escenario 2: Filtro de fecha**</p><p>**Dado** que el productor agricula inicia sesión en la aplicación</p><p>**Cuando** entra a la sección de parcelas, selecciona una parcela y filtra por un rango de fecha </p><p>**Entonces** se muestran los valores de la humedad de la parcela en un rango de fecha especifico</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |7|
|E7-TS102|Monitoreo de condiciones climaticas|**Como** productor agricola **quiero** ver la temperatura de una parcela **para** monitorear el clima en donde estan los cultivos| <p>**Escenario 1: Visualización de los datos**</p><p>**Dado que** el productor agricula inicia sesión en la aplicación</p><p>**Cuando** entra a la sección de parcelas y selecciona una parcela y entra a la sección de temperatura</p><p>**Entonces** se muestran los valores de la temperatura de la parcela en tiempo real.</p><p>**Escenario 2: Filtro de fecha**</p><p>**Dado** que el productor agricula inicia sesión en la aplicación</p><p>**Cuando** entra a la sección de parcelas, selecciona una parcela y filtra por un rango de fecha </p><p>**Entonces** se muestran los valores de la temperatura de la parcela en una fecha especifica</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |7|
|E7-TS103| Manejo del reglas del tiempo de riego |**Como** administrador o productor agricola **quiero** crear reglas de riego por tiempo **para** adaptar el sistema a diferentes cultivos.| <p>**Escenario 1: Definición de reglas**</p><p>**Dado que** el administrador inicia sesión en la aplicación,</p><p>**Cuando** entra a la sección de parcelas y define una politica,</p><p>**Entonces** el sistema la aplica las reglas de riego.</p><p>**Escenario 2: Eliminación**</p><p>**Dado que** el administrador inicia sesión en la aplicación,</p><p>**Cuando** entra a la sección de parcelas y elimina una regla,</p><p>**Entonces** el sistema elimina la regla especifica en las parcelas.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |7|
|E7-TS104|Automatización de riego|**Como** productor agricola **quiero** que el sistema active el riego automaticamente cuando la humedad sea baja **para** optimizar el uso de agua| <p>**Escenario 1: Riego automatico**</p><p>**Dado que** el nivel de humedad esta en niveles bajos</p><p>**Cuando** el sistema recibe la lectura,</p><p>**Entonces** activa el riego hasta alcanzar la humedad objetivo.</p><p>**Escenario 2: Manejo del riego automatico**</p><p>**Dado que** el productor agricola inicia sesión en la aplicación</p><p>**Cuando** el sistema entra a la sección de parcelas y desactiva/reactiva el riego automatico,</p><p>**Entonces** desactiva/reactiva el riego.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |7|
|E7-TS105| Manejo de alertas|**Como** productor agricola **quiero** que el sistema me permita configurar las alertas **para** poder recibir alertas en una condicion climatica especifica| <p>**Escenario 1: Manejo de alertas**</p><p>**Dado que** el administrador inicia sesión en la aplicación,</p><p>**Cuando** entro a la sección de parcelas y a la seccion de alertas</p><p>**Entonces** puede manejar la temperatura especifica requerida para que me envie una alerta.</p><p>**Escenario 2: Desactivación/eliminación de alertas**</p><p>**Dado que** el administrador inicia sesión en la aplicación,</p><p>**Cuando** entro a la sección de parcelas y a la seccion de alertas</p><p>**Entonces** puede desactivar temporalmente/ eliminar alertas.</p>|7|                                                                                       
|E7-TS106|Predicciones de riego|**Como** productor quiero recibir recomendaciones predictivas basadas en patrones historicos **para** mejorar el rendimiento del cultivo| <p>**Escenario 1: Predicciones de riego**</p><p>**Dado que** el productor agricola inicia sesión en la aplicación,</p><p>**Cuando** entra la sección de parcelas y busca el boton de recomendaciones</p><p>**Entonces** genera recomendaciones predictivas.</p><p>**Escenario 2: Filtro de fechas**</p><p>**Dado que** el administrador inicia sesión en la aplicación,</p><p>**Cuando** entra la sección de parcelas y busca el boton de recomendaciones y hace un filtro por un rango respecifico.</p><p>**Entonces** genera predicciones con un rango de fecha especifica.</p>|6|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |7|
|E7-TS107|Dashboard de metricas de riego|**Como** productor busco ver graficos con el uso de agua y humedad alcanzada **para** evaluar la eficiencia del riego| <p>**Escenario 1: Generación de reporte**</p><p>**Dado que** el productor agricola inicia sesión en la aplicación.</p><p>**Cuando** entra a la sección de Parcelas,</p><p>**Entonces** se muestra el dashboard con los gŕaficos con metricas clave en tiempo real.</p><p>**Escenario 2: Manejo del reporte**</p><p>**Dado que** el productor agricola inicia sesión en la aplicación.</p><p>**Cuando** entra a la sección de Parcelas,</p><p>**Entonces** puede ocultar/volver a mostrar los graficos con las metricas clave.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |7|
|E7-TS108|Asosacion de sensores a parcelas|**Como** administrador **quiero** asociar cada sensor con una parcela específica **para** identificar de donde provienen los cultivos| <p>**Escenario 1: Registro del origen del cultivo**</p><p>**Dado que** el administrador inicia sesión en la aplicación selecciona un sensor,</p><p>**Cuando** elige una parcela, </p><p>**Entonces** el sistema registra la asociación.</p><p>**Escenario 2: Eliminación del origen del cultivo**</p><p>**Dado que** el administrador inicia sesión en la aplicación,</p><p>**Cuando** elige una parcela y presiona el boton eliminar </p><p>**Entonces** el sistema eliminacion la asociación.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |7|
|E7-TS109|Visualizacion historica de datos|**Como** productor **quiero** consultar el historial de datos recolectados por los sensores en cada parcela **para** analizar las tendencias y planificar mejor el riego| <p>**Escenario 1: Consulta historica**</p><p>**Dado que** el productor agricola inicia sesión en la aplicación</p><p>**Cuando** el productor entra a la sección de parcelas consulta los datos del ultimo mes,</p><p>**Entonces** se muestran graficas con la variación de humedad y temperatura.</p><p>**Escenario 2: Consulta historica especifica**</p><p>**Dado que** el productor agricola inicia sesión en la aplicación</p><p>**Cuando** el productor entra a la sección de parcelas consulta el rango de fecha especifico,</p><p>**Entonces** se muestran graficas con la variación de humedad y temperatura en un rango de fecha especifica.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |7|
|E7-TS110|Análisis de eficiencia del riego|**Como** administrador **quiero** generar reportes sobre eficiencia de riego **para** evaluar el ahorro de agua en cada parcela| <p>**Escenario 1: Generación de reporte mensual**</p><p>**Dado que** el administrador inicia sesión en la aplicación</p><p>**Cuando** el administrador entra a la sección de parcelas y busca el boton para solicitar el reporte mensual,</p><p>**Entonces** el sistema genera el documento con metricas de eficiencia.</p><p>**Escenario 2: Generación de reporte anual**</p><p>**Dado que** el administrador inicia sesión en la aplicación</p><p>**Cuando** el administrador entra a la sección de parcelas y busca el boton para solicitar el reporte anual,</p><p>**Entonces** el sistema genera el documento con metricas de eficiencia del año.</p>||7|
...
|E8-TS102|Iniciar sesion del usuario atraves de la APIRESTful|**Como** desarrollador **quiero** logear al usuario atraves de la API **para** brindarle acceso a la aplicación| <p>**Escenario 1: Logear Usuario**</p><p>**Dado que** el endpoint "api/v1/sign-in esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos: correo y contraseña</p><p>**Entonces** recibe una respuesta con estado 201 y recibe un recurso con los sigueintes datos: id, correo, rol y json web token </p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |8|
...
|E8-TS104|Crear campo atraves de la APIRESTful|**Como** desarrollador **quiero** crear campo atraves de la API **para** registrarlo en la base de datos | <p>**Escenario 1: Crear Campo**</p><p>**Dado que** el endpoint "api/v1/field" esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes atributos: producerId, fieldName, location, size</p><p>**Entonces** recibe una respuesta con estado 201 y recibe un recurso field con los siguientes atributos: producerId, fieldName, location, size </p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |8|
|E8-TS105|Obtener informacion del campo atraves de la APIRESTful|**Como** desarrollador **quiero** obtener la informacion del campo atraves de la API **para** mostrar los datos en la aplicación | <p>**Escenario 1: Obtener Lista de campos**</p><p>**Dado que** el endpoint "api/v1/field/{producerId}" esta disponible</p><p>**Cuando** envia la solicitud GET con los siguientes parametros: producerId</p><p>**Entonces** recibe una respuesta con estado 200 y recibe un recurso field con los siguientes atributos: producerId, fieldName, location, size </p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |8|
|E8-TS106|Eliminar informacion del campo atraves de la APIRESTful|**Como** desarrollador **quiero** eliminar la informacion del campo atraves de la API **para** eliminar los datos en la aplicación | <p>**Escenario 1: Eliminar campo**</p><p>**Dado que** el endpoint "api/v1/field/{producerId}/delete" esta disponible</p><p>**Cuando** envia la solicitud DELETE con los siguientes parametros: producerId</p><p>**Entonces** recibe una respuesta con estado 200 y recibe un mensaje de recurso eliminado </p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |8|
|E8-TS107|Editar informacion del campo atraves de la APIRESTful|**Como** desarrollador **quiero** editar la informacion del campo atraves de la API **para** editar los datos en la aplicación | <p>**Escenario 1: Editar campos**</p><p>**Dado que** el endpoint "api/v1/field/{id}" esta disponible</p><p>**Cuando** envia la solicitud PUT con los siguientes parametros: id</p><p>**Entonces** recibe una respuesta con estado 200 y recibe un recurso field con los siguientes atributos: id, producerId, fieldName, location, size </p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |8|
|E8-TS108|Crear proceso agricola atraves de la APIRESTful|**Como** desarrollador **quiero** crear el proceso agricola atraves de la API **para** registrarlo en la base de datos| <p>**Escenario 1: Crear Proceso Agricola**</p><p>**Dado que** el endpoint "api/v1/agricultural-processes" esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes atributos: fieldId</p><p>**Entonces** recibe una respuesta con estado 201 y recibe un recurso agricultural activity </p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |8|
...
|E8-TS117|Agregar trabajador atraves de la APIRESTful|**Como** desarrollador **quiero** agregar trabajador atraves de la API **para** registrarlo en la base de datos| <p>**Escenario 1: Agregar Trabajadores**</p><p>**Dado que** el endpoint "api/v1/workers esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos: producerId, fullName, documentNumber</p><p>**Entonces** recibe una respuesta con estado 201 y recibe un recurso worker con los siguientes datos: producerId, fullName, documentNumber</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |8|
|E8-TS118|Obtener trabajadores atraves de la APIRESTful|**Como** desarrollador **quiero** obtener información de los trabajadores atraves de la API **para** registrarlo en la base de datos| <p>**Escenario 1: Obtener Lista de informacion de los trabajadores**</p><p>**Dado que** el endpoint "api/v1/workers/{producerId} esta disponible</p><p>**Cuando** envia la solicitud GET con los siguientes datos: producerId</p><p>**Entonces** recibe una respuesta con estado 200 y recibe un recurso worker con los siguientes datos: producerId, fullName, documentNumber</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |8|
|E8-TS119|Eliminar Trabajador atraves de la APIRESTful|**Como** desarrollador **quiero** eliminar trabajador atraves de la API **para** eliminar los datos en la aplicación| <p>**Escenario 1: Eliminar trabajador**</p><p>**Dado que** el endpoint "api/v1/workers/{id} esta disponible</p><p>**Cuando** envia la solicitud DELETE con los siguientes datos: id, producerId</p><p>**Entonces** recibe una respuesta con estado 200 y recibi el recurso worker con los siguientes datos: producerId, fullName, documentNumber </p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |8|
|E8-TS120|Agregar payment atraves de la APIRESTful|**Como** desarrollador **quiero** agregar payment atraves de la API **para** registrarlo en la base de datos| <p>**Escenario 1: Agregar Trabajadores**</p><p>**Dado que** el endpoint "api/v1/payments esta disponible</p><p>**Cuando** envia la solicitud POST con los siguientes datos: subscriptionId, date, state, cardHolderName, cardNumber, ExpireDate, cvv</p><p>**Entonces** recibe una respuesta con estado 201 y recibe un recurso payment con los siguientes datos: subscriptionId, date, state, cardHolderName, cardNumber, ExpireDate, cvv</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |8|
...
| 3 | E1-US103 | Sección de caracteristicas del producto de landing page | Como visitante quiero visualizar características de la aplicación en el landing page para saber sobre las características que ofrece. | 2 |
...
| 14 | E3-US104 | Programación de fecha de riego de cultivos | Como productor agrícola quiero programar fechas de riego para mejorar el cuidado de los cultivos. | 2 |
...
| 17 | E3-US108 | Delegación de acceso | Como productor agrícola quiero dar acceso a un técnico para que me ayude a gestionar sensores y riegos. | 2 |
| 18 | E3-US109 | Consulta de lecturas | Como productor agrícola quiero ver la humedad y temperatura del suelo por parcela y zona para decidir cuándo regar. | 3 |
...
| 26 | E5-US102 | Página no encontrada (404) | Como usuario quiero ser informado si una página no existe para volver al inicio. | 1 |
| 27 | E6-TS101 | Ver información financiera | Como administrador quiero ver la información financiera para ver el estado financiero en la aplicación. | 2 |
| 28 | E7-TS101 | Lectura de humedad del suelo | Como productor agricola quiero ver los valores actuales de humedad del suelo de una parcela para monitorear el estado de los cultivos. | 4 |
| 29 | E7-TS102 | Monitoreo de condiciones climaticas | Como productor agricola quiero ver la temperatura de una parcela para monitorear el clima en donde estan los cultivos. | 4 |
| 30 | E7-TS103 | Manejo del reglas del tiempo de riego | Como administrador o productor agricola quiero crear reglas de riego por tiempo para adaptar el sistema a diferentes cultivos. | 2 |
| 31 | E7-TS104 | Automatización de riego | Como productor agricola quiero que el sistema active el riego automaticamente cuando la humedad sea baja para optimizar el uso de agua. | 5 |
| 32 | E7-TS105 | Manejo de alertas | Como productor agricola quiero que el sistema me permita configurar las alertas para poder recibir alertas en una condicion climatica especifica. | 4 |
| 33 | E7-TS106 | Predicciones de riego | Como productor quiero recibir recomendaciones predictivas basadas en patrones historicos para mejorar el rendimiento del cultivo. | 2 |
| 34 | E7-TS107 | Dashboard de metricas de riego | Como productor busco ver graficos con el uso de agua y humedad alcanzada para evaluar la eficiencia del riego. | 3 |
...
![Github Pages](./assets/images/chapter-6/evidencia.1.jpg)
...
Nuestro video: [About-the-Product](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202114851_upc_edu_pe/IQDQyTykh5iBSr1yKzAQ9O3PAQlvOE-zTVKCl_rZN-rvBwY?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=M0E9Kr)


![Image](./assets/images/chapter-6/about-pro.png)
