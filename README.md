...
|E3-US107|Proceso de recolección de la cosecha|**Como** productor agricola  **quiero** funcionalidades de apoyo en la recolección de la cosecha **para** ver la productividad del trabajo elaborado| <p>**Escenario 1: Registro de recolección de cosecha**</p><p>**Dado que** el productor agricola inicia sesion en la aplicación</p><p>**Cuando** accede a la sección de Cosecha y registra información como fecha de recolección, peso de la caja y precio por kg</p><p>**Entonces** observa estos datos reflejados en una lista.</p><p>**Escenario 2: Edición de registro de cosecha**</p><p>**Dado que** el productor agrícola tiene datos de recolección registrados.</p><p>**Cuando** accede a la sección de Cosecha y modifica información como el peso o la fecha.</p><p>**Entonces** observa la lista actualizada con los nuevos valores.</p><p>**Escenario 3: Eliminación de registro de cosecha**</p><p>**Dado que** el productor agrícola tiene registros de cosecha guardados.</p><p>**Cuando** selecciona un registro y confirma su eliminación.</p><p>**Entonces** este desaparece de la lista y ya no es considerado en los cálculos de productividad.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |3|
|E3-US108|Proceso de análisis financiero de los cultivos|**Como** productor agricola **quiero** un análisis financiero **para** visualizar la utilidad del trabajo elaborado| <p>**Escenario 1: Visualización de ganancias de un producto**</p><p>**Dado que** el productor agricola inicia sesion en la aplicación</p><p>**Cuando** acceda a la sección de “Finanzas”</p><p>**Escenario 2: Visualización por periodos**</p><p>**Dado que** el productor agrícola tiene múltiples registros financieros.</p><p>**Cuando** filtra la información por mes, trimestre o temporada.</p><p>**Entonces** observa un análisis financiero detallado correspondiente a ese periodo.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |3|
|E3-US109|Delegación de acceso | **Como** productor agricola **quiero**dar acceso a un técnico  **para**  que me ayude temporalmente a gestionar mis sensores y riegos.| <p>**Escenario 1: Visualización de la humedad y temperatura del suelo**</p><p>**Dado que** el productor agricola inicia sesion en la aplicación</p><p>**Cuando** seleccióno la sección de "Permisos" </p><p>**Entonces** asigno permisos a un tecnico para que pueda gestionarla.</p><p>**Escenario 2: Edición de permisos otorgados**</p><p>**Dado que** el productor agrícola ya ha otorgado permisos a un técnico.</p><p>**Cuando** accede a la sección “Permisos” y modifica el nivel o tiempo de acceso.</p><p>**Entonces** el sistema actualiza inmediatamente los permisos asignados.</p><p>**Escenario 3: Revocación de permisos**</p><p>**Dado que** un técnico tiene acceso a la gestión de sensores y riegos.</p><p>**Cuando** el productor agrícola decide revocar dicho acceso.</p><p>**Entonces** el sistema elimina sus permisos y bloquea el acceso a las funcionalidades.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |3|
|E3-US110|Consulta de lecturas | **Como** productor agrícola **quiero** ver la humedad y temperatura del suelo por parcela y zona **para** para decidir cuándo regar| <p>**Escenario 1: Visualización de lecturas de suelo**</p><p>**Dado que** el productor agrícola inicia sesión en la aplicación</p><p>**Cuando** selecciono una parcela en la sección de lecturas</p><p>**Entonces** veo los valores recientes de humedad y temperatura.</p><p>**Escenario 2: Comparación entre zonas**</p><p>**Dado que** el productor agrícola desea analizar diferentes áreas del terreno.</p><p>**Cuando** selecciona dos o más parcelas en la sección de lecturas.</p><p>**Entonces** el sistema muestra un gráfico comparativo con sus niveles de humedad y temperatura.</p><p>**Escenario 3: Historial de lecturas**</p><p>**Dado que** el productor agrícola necesita analizar cambios en el tiempo.</p><p>**Cuando** consulta el historial de lecturas de una parcela.</p><p>**Entonces** observa un registro cronológico de humedad y temperatura.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |3|
|E3-US111|Consumo de agua por parcela | **Como** productor agrícola **quiero** ver cuánto agua he consumido en cada parcela **para** medir eficiencia| <p>**Escenario 1: Reporte de consumo de agua**</p><p>**Dado que** existen datos de riego en la aplicación</p><p>**Cuando** consulto el reporte mensual de una parcela</p><p>**Entonces** veo litros/m³ usados en ese periodo.</p><p>**Escenario 2: Comparación de consumo entre parcelas**</p><p>**Dado que** el productor agrícola tiene datos de consumo de múltiples parcelas.</p><p>**Cuando** selecciona dos o más parcelas en la sección de reportes.</p><p>**Entonces** el sistema muestra un gráfico comparativo del consumo de agua en el mismo periodo.</p><p>**Escenario 3z: Exportación de reporte**</p><p>**Dado que** el productor agrícola desea conservar los datos para análisis externo.</p><p>**Cuando** selecciona la opción de exportar reporte.</p><p>**Entonces** el sistema genera un archivo descargable con el consumo detallado.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |3|
...
|E6-TS101|Lectura de sensores|**Como** productor **quiero** ver los valores actuales de humedad y temperatura **para** monitorear el estado de los cultivos| <p>**Escenario 1: Visualización de los datos**</p><p>**Dado que** los sensores están conectados, </p><p>**Cuando** el productor abre el panel, </p><p>**Entonces** se muestran los valores actualizados en tiempo real.</p><p>**Dado que** hay variaciones en el ambiente, </p><p>**Cuando** cambian los valores, </p><p>**Entonces** el sistema actualiza automáticamente las lecturas.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |6|
|E6-TS102|Asosacion de sensores a parcelas|**Como** administrador **quiero** asociar cada sensor con una parcela específica **para** identificar de donde provienen los cultivos| <p>**Escenario 1: Registro del origen del cultivo**</p><p>**Dado que** el administrador selecciona un sensor,</p><p>**Cuando** elige una parcela, </p><p>**Entonces** el sistema registra la asociación.</p><p>**Dado que** la asociación se realiza, </p><p>**Cuando** se consultan los datos, </p><p>**Entonces** aparecen agrupados por parcela.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |6|
...
|E6-TS104|Visualizacion historica de datos|**Como** productor **quiero** consultar el historial d datos rcolectados por los sensores **para** analizar las tendencias y planificar mejor el riego| <p>**Escenario 1: Consulta historica**</p><p>**Dado que** existen registros de humedad en la base de datos,</p><p>**Cuando** el productor consulta el rango del ultimo mes,</p><p>**Entonces** se muestran graficas con la varación de humedad y temperatura.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |6|
|E6-TS105|Análisis de eficiencia del riego|**Como** administrador **quiero** generar reportes sobre eficiencia de riego **para** evaluar el ahorro de agua en cada parcela| <p>**Escenario 1: Generación de reporte**</p><p>**Dado que** existen registros historicos de riego,</p><p>**Cuando** el administrador solicita un rporte mensual,</p><p>**Entonces** el sistema genera el documento con metricas deeficiencia.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |6|
